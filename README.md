...
4. Use a tool like the ePub Zip-Unzip script to unzip the resulting `epubjs.epub` file.

5. In the resulting `epubjs` unzipped directory, open `epubjs/ops/package.opf` add the following metadata items:
